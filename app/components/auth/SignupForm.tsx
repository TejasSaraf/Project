    ...
    <>
      ...
      <div className="max-w-md mx-auto p-6">
        <form
          ...
          className="flex flex-col gap-4 bg-white background "
        >
          <h1 className="text-lg pt-10 text-center">Create new account</h1>
          ...
          <div>
            ...
            <input
              ...
              type="text"
              {...register("fullName")}
              className={`mt-1 block w-full border rounded-md shadow-sm px-3 py-2 focus:outline-none focus:border-sky-400 ${
          ...
          <div>
            ...
            <input
              ...
              type="email"
              {...register("email")}
              className={`mt-1 block w-full rounded-md shadow-sm border px-3 py-2 focus:outline-none focus:border-sky-400 ${
          ...
          <button
            ...
            className="antialiased md:subpixel-antialiased w-full mt-4 rounded-md shadow-sm bg-[var(--icon-blue-primary)] py-2 text-white font-600 cursor-pointer disabled:opacity-50"
          >
